...
Controller::Controller(QObject *parent) : QObject(parent)
{
    ...
    QString path = "C://Users//Nicholas//Documents//GitHub//CS1D-College-Tour-Project//college.db";
...
QList<Souvenir*> Controller :: customTrip(QString startCollege, QList<QString> tripcolleges)
{
...
QList<Souvenir*> Controller::shortestTrip(QString startCollege, int key)
{
    int numTrip = 0;
    trip* totaltrip  = new trip();
    totaltrip->setfirstcollege(startCollege);
    College* minitrip;
    QList<QString> CollegesVisited;
    QList<Souvenir*>souvtemplist;
